...
BitlySidebar.drawOverlay = function() {
    // BitlySidebar.loadScript("http://bit.ly/static/js/CopyClipboardButton.js?v=3.0");
    ...
    var src = "http://www.baidu.com?" + pars.join("&");
    var iframe = BitlySidebar.createElement('iframe', {"id": "_b_iframe", "src": src, "allowtransparency": "true"});
